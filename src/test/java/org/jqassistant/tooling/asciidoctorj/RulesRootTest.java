...
class RulesRootTest {
    ...
    static void init() throws URISyntaxException {
        ...
        Result res = Result.builder()
                .columnKeys(List.of("Col1", "Col2"))
                .row(Result.Row.builder()
                        .columns(Map.of("Col1", Result.Row.Column.builder()
                                .value("Cell11")
                                .build(), "Col2", Result.Row.Column.builder()
                                .value("Cell12")
                                .build()))
                        .build())
                .row(Result.Row.builder()
                        .columns(Map.of("Col1", Result.Row.Column.builder()
                                ...
                                .build()))
                        .build())
                .baselineRow(Result.Row.builder()
                        .columns(Map.of("Col1", Result.Row.Column.builder()
                                .value("Cell31-base")
                                .build(), "Col2", Result.Row.Column.builder()
                                .value("Cell32-base")
    ...
    void testSortingInRulesRoot() {
        assertThat(rulesRoot.getConcepts()
                .toArray()).hasSize(4);
        assertThat(rulesRoot.getConcepts()
                .first()
                .getId()).isEqualTo("TestConceptId 2");
        assertThat(rulesRoot.getConcepts()
                .last()
                .getId()).isEqualTo("TestConceptId 4");

        assertThat(rulesRoot.getConstraints()
                .toArray()).hasSize(2);
        assertThat(rulesRoot.getConstraints()
                .first()
                .getId()).isEqualTo("TestConstraintId 2");
        assertThat(rulesRoot.getConstraints()
                .last()
                .getId()).isEqualTo("TestConstraintId");
    }

    @Test
    void testRuleToRuleRoot() {
        RuleRoot root = rulesRoot.getConstraints()
                .first();

        assertThat(root.getId()).isEqualTo(tca2.getId());
        assertThat(root.getDescription()).isEqualTo(tca2.getDescription());
        assertThat(root.getStatus()).isEqualTo(tca2.getStatus()
                .toUpperCase());
        assertThat(root.getSeverity()).isEqualTo(tca2.getSeverity()
                .toUpperCase());

        assertThat(root.isHasResult()).isTrue();
        assertThat(root.isHasReports()).isTrue();

        assertThat(root.getResultColumnKeys()).isEqualTo(tca2.getResult()
                .getColumnKeys());
        assertThat(root.getResultRows()
                .get(0)
                .getColumns()).isEqualTo(List.of("Cell11", "Cell12"));
        assertThat(root.getResultRows()
                .get(1)
    ...
    void testCopyingOfResources() throws IOException {
        ...
        assertThat(Paths.get(attributes.getOutputDirectory()
                        .toURI())
                .resolve("it_CSVReport.csv")
                .toFile()).isFile();
        assertThat(Paths.get(attributes.getImagesDirectory()
                        .toURI())
                .resolve("it_ToBeContextMapReport.svg")
                .toFile()).isFile();
    }
    ...
    void testParseBaselineResult() {
        ...
        assertThat(root.getBaselineRows()
                .get(0)
                .getColumns()).isEqualTo(List.of("Cell31-base", "Cell32-base"));
    }
    ...
    void testParseSuppressedResult() {
        ...
        RuleRoot.SuppressedRowRoot suppressedRow = root.getSuppressedRows()
                .get(0);
        assertThat(suppressedRow.getColumns()).isEqualTo(List.of("Cell41-supp", "Cell42-supp"));
